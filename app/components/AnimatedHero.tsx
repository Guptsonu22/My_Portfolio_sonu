        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
          ...
          <div className="flex flex-col items-center md:items-start order-2 md:order-1 mt-8 md:mt-0">
            ...
            >
              ...
              {/* LeetCode */}
              <motion.a
                href="https://leetcode.com/u/sonugupta411093/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gradient-to-r from-orange-500 to-yellow-500 rounded-full flex items-center justify-center hover:from-orange-600 hover:to-yellow-600 transition-colors shadow-md"
                whileHover={{
                  scale: 1.2,
